...
namespace MultiplayerSample
{
    ...
    struct ClientEffect
    {
        Multiplayer::LongNetworkString m_effectName;               // The effect to play upon weapon hit confirmation
    ...
    struct WeaponParams
    {
        AZ_RTTI(WeaponParams, "{52FB7AC0-A1FB-40F7-89C9-FE1EDC79819D}");
        ...
        Multiplayer::LongNetworkString m_activateFx;   // The effect to play upon weapon activation
        Multiplayer::LongNetworkString m_impactFx;     // The effect to play at the point of impact upon weapon hit. Played predictively for autonomous clients, and authoritatively for simulated clients
        Multiplayer::LongNetworkString m_damageFx;     // The effect to play for each hit entitiy. Played authoritatively only
        Multiplayer::LongNetworkString m_projectileAsset;  // If a projectile weapon, the prefab asset name for the projectile entity
        Multiplayer::LongNetworkString m_ammoMaterialType; // The effects material type of the ammo for bullet decals and other material effects (@TODO: Requires a replacement for the material effects system)
        GatherParams m_gatherParams;                   // The type of gather to perform for trace weapons
        HitEffect m_damageEffect;
