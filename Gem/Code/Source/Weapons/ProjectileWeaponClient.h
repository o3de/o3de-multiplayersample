...
{
    /**
     * @class ProjectileWeaponClient
     * @brief Client-side weapon class for projectile-based weapons
     */
    class ProjectileWeaponClient AZ_FINAL
    ...
    public:
         ...
         */
        ProjectileWeaponClient(const BaseWeapon::ConstructParams& a_ConstructParams, BaseWeaponClientListener& a_Listener);

        /**
         * Destructor
         */
        virtual ~ProjectileWeaponClient();
    ...
    private:
        ...
        ProjectileWeaponClient &operator =(const ProjectileWeaponClient &) = delete;
    };
}
